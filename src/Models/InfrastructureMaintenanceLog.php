...
class InfrastructureMaintenanceLog extends Model
{
    use Filterable;
    use HasMeta;
    use HasPageSetup;
     ...
     * @var string
     */
    protected $table = 'infrastructure_maintenance_logs';
     ...
     * @var array
     */
    protected $roles = ['infrastructure-maintenance-log'];
     ...
     * @return void
     */
    public static function updateRecord(Request $request,InfrastructureMaintenance $main_model, $model = null) : InfrastructureMaintenanceLog
    {
        $model->maintenance_id = $main_model->id;   
        $model->save();
        return $model;
